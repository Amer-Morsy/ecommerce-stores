...
@section('title', __('general.add') .' | '. __('general.options'))
@section('content')
                                        ...
                                        <form class="form"
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label
                                                                for="product_id"> {{ __('general.select') .' '. __('general.product') }}
                                                            </label>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label
                                                                for="attribute_id"> {{ __('general.select') .' '. __('general.attributes') }}
                                                            </label>
                                            ...
                                            <div class="form-actions">
                                                ...
                                                <button type="submit" class="btn btn-primary">
                                                    <i class="ft-check"></i> {{ __('general.save')}}
                                                </button>
                                            </div>
                                        </form>
