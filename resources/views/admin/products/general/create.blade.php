...
@section('title', __('general.add') .' | '. __('general.products'))
@section('content')
                                        ...
                                        <form class="form" action="{{route('admin.products.general.store')}}"
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="slug"> {{__('general.slug')}}</label>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label
                                                                for="description"> {{__('general.description')}}</label>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label
                                                                for="short_description"> {{__('general.short_description')}}</label>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label
                                                                for="categories"> {{__('general.select')}} {{__('general.categories')}}</label>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label for="tags"> {{__('general.select')}} {{__('general.tags')}}</label>
                                                            <select id="tags" name="tags[]" class="select2 form-control"
                                                                    multiple>
                                                                <optgroup label=" {{__('general.select')}} ">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label
                                                                for="brand_id">{{__('general.select')}}  {{__('general.brands')}}
                                                            </label>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group mt-1">
                                                            <input type="checkbox" value="1" name="is_active"
                                                                   id="is_active" class="switchery" data-color="success"
                                                                   checked/>
                                                            <label for="is_active"
