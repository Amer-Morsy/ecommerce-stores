                        ...
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a
                                        href="{{route('admin.brands')}}"> {{__('general.brands')}}</a>
                                </li>
                                <li class="breadcrumb-item active"> {{__('general.edit') }} - {{$brand->name}}
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title"
                                        id="basic-layout-form"> {{__('general.edit')}} </h4>
                                         ...
                                         <div class="col-md-6">
                                             <div class="form-group">
                                                 <div class="text-center">
                                                     <img
                                                         src="{{$brand  -> photo}}"
                                                         class="height-250" alt="{{__('general.photo')}}">
                                                 </div>
                                             </div>
